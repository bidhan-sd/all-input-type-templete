<?php
    ...
    $sql = "UPDATE `addstudent` SET `is_deleted`='1' WHERE id = '$id' AND userId='$userId' ";
    $query = mysql_query($sql, $link);
    $_SESSION['message'] = "<span style='color:green;font-weight:bold'> Data Move into Recycle Bin folder !</span> ";
